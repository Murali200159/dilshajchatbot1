...
async def root(request: Request):
    ...
    # Redirect to the widget demo for convenience
...
async def health_check(request: Request) -> Dict[str, Any]:
    ...
    try:
        ...
        async with httpx.AsyncClient(timeout=3.0) as client:
            # /api/tags is a lightweight endpoint in Ollama
    ...
    is_healthy = db_healthy and llm_healthy
    ...
    # If DB or LLM is unhealthy, set the appropriate status code
