...
class Settings:
    ...
    def __init__(self):
        ...
        self.OLLAMA_MODEL = os.getenv("OLLAMA_MODEL", "dilshaj-ai")
        self.OLLAMA_TEMPERATURE = float(os.getenv("OLLAMA_TEMPERATURE", "0.3"))
        
        # LLM Configuration (Mapped to Ollama)
        ...
        self.DEFAULT_LLM_MODEL = self.OLLAMA_MODEL
        self.DEFAULT_LLM_TEMPERATURE = self.OLLAMA_TEMPERATURE
        self.MAX_TOKENS = int(os.getenv("MAX_TOKENS", "4096"))

        # Long term memory Configuration
        self.LONG_TERM_MEMORY_MODEL = os.getenv("LONG_TERM_MEMORY_MODEL", "llama3")
        self.LONG_TERM_MEMORY_EMBEDDER_MODEL = os.getenv("LONG_TERM_MEMORY_EMBEDDER_MODEL", "nomic-embed-text")
        self.LONG_TERM_MEMORY_COLLECTION_NAME = os.getenv("LONG_TERM_MEMORY_COLLECTION_NAME", "longterm_memory")
        self.MEM0_VECTOR_STORE_URL = os.getenv("MEM0_VECTOR_STORE_URL", "") # Local path if empty
        # JWT Configuration
        ...
        self.MONGO_DB_NAME = os.getenv("MONGO_DB_NAME", "company_app")
