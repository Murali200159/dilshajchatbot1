...
*   **Knowledge (RAG)**: FAISS indexes local company docs (`.md`) for instant retrieval.
...
-   ⚡ **GPU Acceleration**: Built-in NVIDIA CUDA support for llama3.1 inference.
-   🧠 **Stateful Memory**: Remembers user preferences over time using Berlekamp-Massey memory patterns.
...
-   📊 **Health Metrics**: Integrated Prometheus-style metrics and health dashboard.
...
# Edit .env.production and set your JWT_SECRET_KEY
```
...
| **LLM** | Ollama (llama3.1) | 11434 | Secured |
| **Vector DB** | Qdrant | 6333 | Secured |
| **Database** | MongoDB 7.0 | 27017 | Secured |
| **Proxy** | Nginx | - | 80 / 443 |
